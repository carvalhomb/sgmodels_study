...
```{r qualitative_data_stats2, echo=FALSE, results="asis", cache=TRUE}
...
```{r qualitative_data_counts_atmsg, echo=FALSE, results = "asis", cache=TRUE}
...
```{r qualitative_data_counts_lmgm, echo=FALSE, results = "asis", cache=TRUE}
