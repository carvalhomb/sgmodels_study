...
anova_table <- car::Anova(lmmodel_sus_atmsg,type=c("II"), contrasts=list(topic=contr.sum, sys=contr.sum), singular.ok=TRUE, multivariate=FALSE)

#formula = sus_score ~ gamefam + sgsfam + game
#aov_car(formula, data=ATMSG_data, observed = c("gamefam","sgsfam"), anova_table = list(correction = c("GG", "HF", "none"), es = "pes", MSE = TRUE, sig.symbols = c("", " *", " **", " ***")))

#kable(anova_table)
kable(afex::nice(anova_table, es = "ges", observed = c("gamefam","sgsfam"),
...
#kable(anova_table2)
#kable(
afex::nice(anova_table2, es = "ges", observed = c("gamefam","sgsfam"),
    correction = c("GG", "HF", "none"), MSE = TRUE,
    sig.symbols = c("", " *", " **", " ***"))
#)
...
afex::anova(atmsg_paired_model, es = "ges", observed = "gamefam",
    correction = c("GG", "HF", "none"), MSE = TRUE,
    sig.symbols = c("", " *", " **", " ***"))
